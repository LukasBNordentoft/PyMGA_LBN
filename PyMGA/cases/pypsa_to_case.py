...
class PyPSA_to_case:
    ...
    def write_network(self):
        ...
        # n.snapshot_weightings = (n.snapshot_weightings*0 + (1/10)).astype(int)
        
        # n.snapshot_weightings = (n.snapshot_weightings*0 + int(8760/200)).astype(int)
        # n.snapshot_weightings = (n.snapshot_weightings*0 + int(8760/8760)).astype(int)
        # n.snapshot_weightings = (n.snapshot_weightings*0 + int(self.n_snapshots/self.n_snapshots)).astype(int)
